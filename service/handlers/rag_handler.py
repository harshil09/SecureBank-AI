...
- If the user asks for their own email, name, or user id and INJECTED_CONTEXT includes those values (not "Guest"/"Not available"), state them briefly from INJECTED_CONTEXT.
